      ...
      if (this.countdown <= 0) {
        ...
        this.route.queryParams.subscribe((params: any) => {
          ...
          this.amount = params.vnp_Amount
            ...
            : 0; // Chia cho 100 để chuyển đổi từ VND sang VNĐ
          this.money = this.atmService.getBalance() || 0 + this.amount;
          this.atmService
            .saveHisBalance(
              this.userService.getCookies(),
              'Nạp tiền ' + params.vnp_SecureHash,
              this.amount,
              this.money
            )
            .subscribe(
          ...
          this.atmService
            .updateBalan(this.amount, this.userService.getCookies())
            .subscribe(
              (response: any) => {
